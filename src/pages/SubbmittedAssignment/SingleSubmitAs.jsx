        ...
        <div>
            <div>
                <div className="newtime ">
                            ...
                            <div className="p-4">
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="md:flex mt-8">
                                        ...
                                        <div className="border-2  mt-4 mx-auto w-[84%] text-center md:w-[50%]  rounded-xl px-8 py-2 ">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 px-4'>
                        ...
                        <div className="bg-white rounded-2xl mt-4 ">
                            <div className="p-4">
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-14 mr-8 '>
                                    <div className="">
                                    </div>
                                    <div className=" ">
                                        {
                    ...
                    <div className="bottom-section bg-white rounded-2xl">
                    </div>
                </div>
            </div>
        </div>
